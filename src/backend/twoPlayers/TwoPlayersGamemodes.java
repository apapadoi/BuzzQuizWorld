 ...
 * @version 10.11.2020
 * */
public enum TwoPlayersGamemodes implements PlayableNumOfPlayers {
    PointBuilder{
        @Override
    ...
    public static List<String> getAvailableGamemodes() {
        ...
        for(PlayableNumOfPlayers currentGamemodeId : TwoPlayersGamemodes.values())
